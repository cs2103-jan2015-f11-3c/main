...
const std:: string architectureLogic::SEVERITY_LEVEL_WARNING = "Warning";
const std:: string architectureLogic::SEVERITY_LEVEL_INFO = "Info";
const std:: string architectureLogic::SEVERITY_LEVEL_ERROR = "Error";
const std:: string architectureLogic::MESSAGE_LOG_INVALID = "Invalid User Input";
const std:: string architectureLogic::MESSAGE_END_USAGE = "end of previous usage";

const std:: string architectureLogic::COMMAND_INVALID = "invalid";
const std:: string architectureLogic::COMMAND_ADD = "add";
const std:: string architectureLogic::COMMAND_SHORTCUT_ADD = "a";
const std:: string architectureLogic::COMMAND_DELETE = "delete";
const std:: string architectureLogic::COMMAND_SHORTCUT_DELETE = "del";
const std:: string architectureLogic::COMMAND_CLEAR = "clear";
const std:: string architectureLogic::COMMAND_SHORTCUT_CLEAR = "clr";
...
const std:: string architectureLogic::COMMAND_SHORTCUT_DONE = "d";
const std:: string architectureLogic::COMMAND_UPDATE = "update";
const std:: string architectureLogic::COMMAND_SHORTCUT_UPDATE = "up";
const std:: string architectureLogic::COMMAND_SAVE = "save";
const std:: string architectureLogic::COMMAND_FILTER = "filter";
const std:: string architectureLogic::COMMAND_SHORTCUT_FILTER = "fil";
const std:: string architectureLogic::COMMAND_DISPLAY = "display";
const std:: string architectureLogic::COMMAND_SHORTCUT_DISPLAY = "dis";
const std:: string architectureLogic::COMMAND_SEARCH = "search";
const std:: string architectureLogic::COMMAND_SHORTCUT_SEARCH = "srh";
...
const std:: string architectureLogic::DEFAULT_YEAR = "2015,"; 
...
bool architectureLogic::isMultiTimeValid(std::string startDay,std::string startMonth,std::string startHour,std::string startMin,std::string endDay,std::string endMonth,std::string endHour, std::string endMin) {
	int startIntHour = stringToInteger(startHour);
	int startIntMin = stringToInteger(startMin);
	int endIntHour = stringToInteger(endHour);
	int endIntMin = stringToInteger(endMin);
...
std:: string architectureLogic::searchTask(std:: string searchContent) {
	...
	if(architectureStorage::isMasterTaskListEmpty() && architectureStorage::isFloatingTaskListEmpty()) {
		...
		std:: string feedback;
		feedback = architectureStorage::searchContentInStorage(searchContent);
		return feedback;
	}
}